...
public class DisconnectAction extends TerminalViewAction
{
    public DisconnectAction(ITerminalView target) {
        super(target,
              DisconnectAction.class.getName());

        setText("Disconnect");
        setEnabled(false);
		setImageDescriptor(Activator.getInstance().getImageCache().getDescriptor("icons/disconnect.png"));
    }
	public void run() {
