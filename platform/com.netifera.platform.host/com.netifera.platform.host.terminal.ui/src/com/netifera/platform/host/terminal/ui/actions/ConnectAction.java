...
public class ConnectAction extends TerminalViewAction
{
    public ConnectAction(ITerminalView target)
    {
        super(target,
              ConnectAction.class.getName());

        setText("Connect");
		setImageDescriptor(Activator.getInstance().getImageCache().getDescriptor("icons/connect.png"));
    }
	public void run() {
