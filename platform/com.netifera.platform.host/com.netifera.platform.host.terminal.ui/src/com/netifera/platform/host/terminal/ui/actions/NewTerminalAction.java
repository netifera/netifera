 ...
 */
public class NewTerminalAction extends TerminalViewAction implements IMenuCreator {
	private Menu fMenu;
    public NewTerminalAction(ITerminalView target)
    {
        super(target, NewTerminalAction.class.getName());

        setText("Open &Terminal");
        setToolTipText("Open Terminal");
		setImageDescriptor(Activator.getInstance().getImageCache().getDescriptor("icons/new_terminal.png"));
	...
	public Menu getMenu(Control parent) {
		if(fMenu==null) {
			...
			new Action("New Terminal Connection In Current View") {
				public void run() {
					fTarget.onTerminalNewTerminal();
				}
