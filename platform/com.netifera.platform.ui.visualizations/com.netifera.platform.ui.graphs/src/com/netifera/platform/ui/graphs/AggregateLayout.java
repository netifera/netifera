...
/**
 * Layout algorithm that computes a convex hull surrounding aggregate items
 * and saves it in the "_polygon" field.
 */
class AggregateLayout extends Layout {

	private int m_margin = 24; // convex hull pixel margin
